...
protocol cardViewDelegate: class {
    ...
    func cardView(_ view: CardView, didLikeUser user: Bool)

}

// swipeDirection에 원시값 설정
...
class CardView: UIView {
    ...
    init(viewModel: CardViewModel) {
        ...
        //sdWebImage 이미지 설정을 편리하게 해주는 라이브러리
    ...
    func configureBarStackView() {
        ...
        barStackView.anchor(top: topAnchor, left: leftAnchor, right: rightAnchor, paddingTop: 8, paddingLeft: 8, paddingRight: 8,
        height: 4)
    }
